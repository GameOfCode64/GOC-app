...
import img2 from "@/public/images/foodd.png";
import img3 from "@/public/images/shoemap.png";
...
const WebProject = () => {
  return (
    <div className="md:flex inline-block gap-5 px-4 py-3 m-auto">
        ...
        {Cardcontent.map((item, index) => (
          <div className="px-3 py-2 m-auto" key={index}>
            ...
            <div className="mt-3">
              ...
              <div className="grid mb-4 mt-3 gap-[5px] grid-cols-3 lg:grid-cols-4 md:grid-cols-3 grid-rows-none cursor-pointer">
      ...
      <Card className="md:w-[410px] w-full mt-4 md:mt-0 border-[1px]">
        {Cardcontent2.map((item, index) => (
          <div className="px-3 py-2 m-auto" key={index}>
            <div className="h-[40%] w-full object-fill">
              <Image src={item.imgsrc} alt="img" className="object-fill" />
            </div>
            <div className="mt-3">
              <Link href={item.href}>
                <h1 className="font-semibold">{item.title}</h1>
